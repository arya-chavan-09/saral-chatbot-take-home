...
Poor chunk boundaries can reduce retrieval relevance and answer quality.

### Limited Corpus Size

The chatbot can only answer questions grounded in the papers that have been ingested.

### Context Window Constraints

Only a subset of retrieved chunks can be passed to the model for generation.

### Citation Accuracy

Citation quality depends on successful retrieval of supporting chunks.

### Evaluation Coverage

Automated metrics provide useful signals but do not fully replace human evaluation.
...
* Advanced factuality evaluation
